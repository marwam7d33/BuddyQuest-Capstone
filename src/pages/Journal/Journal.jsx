...
//     try {
//       const response = await axios.post(`${BASE_URL}/journals`, newJournal);
//       setJournals((prev) => [...prev, response.data]); // Add to state
//       alert("Journal entry created successfully!");
//       resetForm(); // Clear the form (if applicable)
//     } catch (error) {
...
//     try {
//       const response = await axios.put(`${BASE_URL}/journals/${currentJournal.id}`, updatedJournal);
//       setJournals((prev) =>
//         prev.map((journal) =>
//           journal.id === currentJournal.id ? response.data : journal
//         )
//       );
...
//   // Mock user_id assignment (Replace with actual logic)
//   useEffect(() => {
//     // Assume the user is logged in and their ID is stored in localStorage/session
